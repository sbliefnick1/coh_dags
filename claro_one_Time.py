...
sftp1 = SFTPOperator(task_id='202001-202004',
                     ssh_conn_id='claro_sftp',
                     local_filepath=f'/var/nfsshare/files/claro/Claro Healthcare Data Flat Month-202001-202004.xlsx',
                     remote_filepath=f'/Claro Healthcare Data Flat Month-202001-202004.xlsx',
                     create_intermediate_dirs=True,
                     dag=dag)

sftp2 = SFTPOperator(task_id='202005-202008',
                     ssh_conn_id='claro_sftp',
                     local_filepath=f'/var/nfsshare/files/claro/Claro Healthcare Data Flat Month-202005-202008.xlsx',
                     remote_filepath=f'/Claro Healthcare Data Flat Month-202005-202008.xlsx',
                     create_intermediate_dirs=True,
                     dag=dag)

sftp3 = SFTPOperator(task_id='202009-202012',
                     ssh_conn_id='claro_sftp',
                     local_filepath=f'/var/nfsshare/files/claro/Claro Healthcare Data Flat Month-202009-202012.xlsx',
                     remote_filepath=f'/Claro Healthcare Data Flat Month-202009-202012.xlsx',
                     create_intermediate_dirs=True,
                     dag=dag)
