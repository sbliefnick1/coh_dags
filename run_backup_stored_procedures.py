...
t3_bash = "cd C:\\Anaconda\\ETL\\fi_dm_ebi && conda activate foundation && python version_stored_procedures.py && cd ebi-stored-procedures && git diff --quiet && git diff --staged --quiet || git commit -am 'add changes' && git push"
